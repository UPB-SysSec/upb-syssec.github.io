...
In the following, we first detail the findings of our HTTP version server support scan.
Then, we present the results of our censorship analysis for both countries.
...
### Censorship
<!-- I would put this first in Contributions with actual example of how we can access a blocked site with unencrypted HTTP/2-->
